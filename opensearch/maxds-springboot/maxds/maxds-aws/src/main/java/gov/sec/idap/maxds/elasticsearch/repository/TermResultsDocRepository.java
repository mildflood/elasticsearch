...
public interface TermResultsDocRepository extends ElasticsearchRepository<TermResultsDoc, String> {
    ...
    @Query("{\r\n"
    		...
    		+ "    		    }\r\n"
    		+ "    		  }")
    public List<TermResultsDoc> findByEntityIdListAndTermIdAndMyDocType(Collection<String> entityIds, String termId, String myDocType, Pageable pageable);
    ...
    @Query("{ \r\n"
    		...
    		+ "      ], \r\n"
    		+ "      \"filter\": { \"bool\": { \"must\": [\r\n"
    		+ "                { \"terms\":  { \"termId.keyword\": ?1 }},\r\n"
    		+ "				{ \"terms\":  { \"entityId.keyword\": ?0 }}\r\n"
    		+ "      ]}}\r\n"
    		+ "    }\r\n"
    		+ "  }")
    public List<TermResultsDoc> findByEntityIdListAndTermIdListAndMyDocType(Collection<String> entityIdList, Collection<String> termIdList, String myDocType);
...
//              Collection<String> entityIds, int start, int end);
    ...
    public List<TermResultsDoc> findByTermsInAndEntityIdAndFYAndFQ(Collection<String> termIds,
            String entityId, int fy, String fq, Pageable pageable);
