...
//                    );
            		= normalizedFactService.findMatchingExtendedElementNameInfo(entityMap.keySet(), resolvedExpression);
...
//                            resolvedExpression.balanceType
//                    );
            		 = normalizedFactService.findMatchingExtendedElementNameInfoWithDimension(entityMap.keySet(), resolvedExpression);
