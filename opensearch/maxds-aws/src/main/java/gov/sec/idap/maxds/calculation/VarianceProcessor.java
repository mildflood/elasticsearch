...
public class VarianceProcessor {
    ...
    private String getPreviousPeriodKey(TermResultsDoc tr)
    {
        ...
        {
            case Q1:
                return buildTermResultkey(tr.getEntityId(),  FQTypeCode.Q4, tr.FY-1);
            
                
            case Q2:
                return buildTermResultkey(tr.getEntityId(),FQTypeCode.Q1, tr.FY);
                
            case Q3:
               return buildTermResultkey(tr.getEntityId(),FQTypeCode.Q2, tr.FY);
                
            case Q4:
               return buildTermResultkey(tr.getEntityId(),FQTypeCode.Q3, tr.FY);
           case FY:
                return buildTermResultkey(tr.getEntityId(),FQTypeCode.FY, tr.FY-1);
    ...
    private String getSamePeriodPreviousYearKey(TermResultsDoc tr)
    {
        ...
        {
            case Q1:
                return buildTermResultkey(tr.getEntityId(),FQTypeCode.Q1, tr.FY-1);
            
                
            case Q2:
                return buildTermResultkey(tr.getEntityId(),FQTypeCode.Q2, tr.FY-1);
                
            case Q3:
               return buildTermResultkey(tr.getEntityId(),FQTypeCode.Q3, tr.FY-1);
